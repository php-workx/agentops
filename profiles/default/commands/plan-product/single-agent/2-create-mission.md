Now that you've gathered information about this product, use that info to create the mission document in `product/mission.md` by following these instructions:
...
```
✅ I have documented the product mission at `product/mission.md`.
