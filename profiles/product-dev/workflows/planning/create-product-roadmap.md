Generate `agentops/spec-first-dev/product/roadmap.md` with an ordered feature checklist:
...
1. **Review the Mission** - Read `agentops/spec-first-dev/product/mission.md` to understand the product's goals, target users, and success criteria.
