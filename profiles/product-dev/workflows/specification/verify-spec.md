...
Read `agentops/spec-first-dev/specs/[this-spec]/planning/requirements.md` and verify:
...
1. **Read each visual file** in `agentops/spec-first-dev/specs/[this-spec]/planning/visuals/`
...
3. **Verify these design elements appear in**:
   - `agentops/spec-first-dev/specs/[this-spec]/spec.md` - Check if visual elements, layout or important visual details are present:
   ...
   - `agentops/spec-first-dev/specs/[this-spec]/tasks.md` - Confirm at least some tasks specifically reference:
     * Visual file names
     * Components shown in visuals
     * Layouts depicted in mockups

#### Check 4: Requirements Deep Dive
Read `agentops/spec-first-dev/specs/[this-spec]/planning/requirements.md` and create a mental list of:
...
Read `agentops/spec-first-dev/specs/[this-spec]/spec.md` and verify each section:
...
Read `agentops/spec-first-dev/specs/[this-spec]/tasks.md` and check each task group's tasks:
...
Create `agentops/spec-first-dev/specs/[this-spec]/verification/spec-verification.md` with the following structure:
...
See agentops/spec-first-dev/specs/[this-spec]/verification/spec-verification.md for full details.
```
