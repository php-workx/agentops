...
1. **Read Product Mission**: Load `agentops/spec-first-dev/product/mission.md` to understand:
...
2. **Read Product Roadmap**: Load `agentops/spec-first-dev/product/roadmap.md` to understand:
...
3. **Read Product Tech Stack**: Load `agentops/spec-first-dev/product/tech-stack.md` to understand:
